...
// import { Posts, filterPosts } from '../Posts';

// export const Header = () => {
//     return <div className={styles.header}>
//         <h1 className={styles.title}>Muse discography</h1>
//         <div onClick={()=>setValue(0)} className={styles.all}>
...
//             See All
//         </div>
//         <div onClick={()=>setValue(1)} className={styles.fav}>
